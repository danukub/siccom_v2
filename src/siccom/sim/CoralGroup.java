...
public abstract class CoralGroup
{
	 ...
	 */
	public Color color;						// initial color for the simulation
	/**
	 ...
	 */
	public int	fixRecImport;					// number of recruits per event
...
//	public double relCover;
						...
						double maxDeathTemp)
	{
		...
		this.minBleachTemp		= minBleachTemp;
		this.maxBleachTemp 		= maxBleachTemp;
		this.minDeathTemp		= minDeathTemp;
		this.maxDeathTemp		= maxDeathTemp;
	}
